  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        <div className="glass mb-6 inline-flex items-center gap-2 rounded-full px-4 py-2 text-xs text-muted-foreground">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a href="#join" className="btn-primary-glow rounded-2xl px-8 py-4 text-base font-bold">
            Присоединиться
          </a>
          <a href="#about" className="btn-ghost-glow rounded-2xl px-8 py-4 text-base font-semibold">
            Узнать больше
          </a>
        </div>
      </div>
