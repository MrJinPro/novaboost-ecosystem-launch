...
const stats = [
  { label: "Рост аудитории", value: "—", note: "обновляется" },
  { label: "Рост дохода стримеров", value: "—", note: "обновляется" },
  { label: "Активных стримеров", value: "—", note: "обновляется" },
  { label: "Проведённых эфиров", value: "—", note: "обновляется" },
  { label: "Суммарных просмотров", value: "—", note: "обновляется" },
];
