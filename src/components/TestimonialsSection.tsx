...
const reviews = [
  {
    ...
    text: "Куратор реально помогает — за пару недель разобралась с эфирами и виджетами. До NovaBoost я просто стримила, теперь это работа.",
    avatar: "А",
  },
  {
    name: "Дмитрий В.",
    role: "Контент-креатор",
    text: "Понравилось, что всё прозрачно: оферта, проценты, условия выхода. Никаких скрытых пунктов. Аналитика и инструменты — топ.",
    avatar: "Д",
  },
  {
    name: "Мария Л.",
    role: "Куратор NovaBoost",
    text: "Технологическая база, которой нет у других агентств. Виджеты, озвучка чата и подарков, оверлеи — наши стримеры выглядят профессионально.",
    avatar: "М",
  },
];
